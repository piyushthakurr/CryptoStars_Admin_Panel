...
const RemoveLiquidity = (props) => {
  ...
  console.log("tokenListPPPPPP", tokenList);
  ...
  console.log("tokenList11111", tokenList);
  useEffect(() => {
  ...
  const approveTransaction = async () => {
    ...
    if (nwChangeId == 338) {
      ...
      data = {
        owner: isUserConnected,
        spender: MAIN_CONTRACT_LIST.router.address2,
        value,
        deadline: dl,
      };
      ...
      data = {
        owner: isUserConnected,
        spender: MAIN_CONTRACT_LIST.router.address3,
        value,
        deadline: dl,
      };
    }
  ...
  const removeLiquidity = async () => {
    ...
    if (checkBNB) {
      ...
      try {
        ...
        console.log(result, "remove liquidity transaction11111111111111");
        dispatch(stopLoading());
      ...
      console.log("dataForRemoveliquidity600", data);
      console.log("signedData", signedData);
      try {
        const result = await ExchangeService.removeLiquidityWithPermit(data);
        console.log(result, "remove liquidity transaction22222222222222");
        // dispatch(stopLoading());
        if (result) {
      ...
      <Card className="">
        ...
        <div className="Liquiditybox">
          <ul>
            <li>
              Amount{" "}
              <span onClick={() => setScreenType(!screenType)}>
            ...
            <>
              ...
              <ul>
                <li>
                  ...
                  <button type="button" onClick={() => handleChange2(50)}>
                    50%
                  </button>
                  <button type="button" onClick={() => handleChange2(75)}>
                    75%
                  </button>
        ...
        {screenType ? (
          <>
            ...
            <div className="Liquiditybox info">
              <ul>
                <li>
                  <p>{tokenOneValue.toFixed(5)}</p>{" "}
                  <span className="white">{tokenOne.symbol}</span>
                </li>
                <li>
                  <p>{tokenTwoValue.toFixed(5)} </p>
                  <span className="white">{tokenTwo.symbol}</span>
                </li>
                {checkBNB && (
                  <li>
                    <p></p>{" "}
          ...
          <div className="LiquidityboxInput">
            {currentPairAddress && (
              <div className={`col InputSelectCurrency_style`}>
            ...
            <Card className="selectCurrency_modal">
              ...
              <div className="col tokenList__column borderClassup">
                ...
                <div className="borderClass removeModalClass ">
                  ...
                  <ul>
                    <li>
                      Flip {tokenOneCurrency}/{tokenTwoCurrency} Burned:
                      <span>
                        <img src={tokenOne.icon} alt="icon" />
