...
const allPairs = async () => {
  ...
  console.log("allPairsnwChangeId", nwChangeId);
  try {
    let contract;
    if (nwChangeId == 338) {
      ...
      contract = await ContractServices.callContract(
        MAIN_CONTRACT_LIST.factory.address2,
        MAIN_CONTRACT_LIST.factory.abi
      );
    } else if (nwChangeId == 43113) {
      contract = await ContractServices.callContract(
        MAIN_CONTRACT_LIST.factory.address3,
        MAIN_CONTRACT_LIST.factory.abi
      );
    }
...
const getPair = async (token1, token2) => {
  console.log("token1Getpair", token1);
  console.log("token2Getpair", token2);

  const nwChangeId = localStorage.getItem("staticNwId");
  console.log("getPairnwChangeId", nwChangeId);
  try {
    let contract;
    // contract = await ContractServices.callContract(
    //   MAIN_CONTRACT_LIST.factory.address,
    ...
    if (nwChangeId == 338) {
      ...
      console.log("getPairnwChangeId1", nwChangeId);
    } else if (nwChangeId == 97) {
      contract = await ContractServices.callContract(
        MAIN_CONTRACT_LIST.factory.address2,
        MAIN_CONTRACT_LIST.factory.abi
      );
      console.log("getPairnwChangeId2", nwChangeId);
    } else if (nwChangeId == 43113) {
      contract = await ContractServices.callContract(
        MAIN_CONTRACT_LIST.factory.address3,
        MAIN_CONTRACT_LIST.factory.abi
      );
      console.log("getPairnwChangeId3", nwChangeId);
    }

    return await contract.methods.getPair(token1, token2).call();
  } catch (error) {
    console.log("ErrorGETPAIR", error);
    return error;
  }
};
...
const getAmountsOut = async (amountIn, pair) => {
  try {
    ...
    const nwChangeId = localStorage.getItem("staticNwId");
    console.log("getAmountsInChangeId", nwChangeId);
    let contract;
    if (nwChangeId == 338) {
      contract = await ContractServices.callContract(
...
const addLiquidity = async (data, cbk) => {
  const nwChangeId = localStorage.getItem("staticNwId");
  console.log("DataAAAAAAA", data, nwChangeId);
  try {
    let {
      tokenA,
      tokenB,
    ...
    if (nwChangeId == 338) {
      ...
      console.log("if else", nwChangeId);
    } else if (nwChangeId == 97) {
      contract = await ContractServices.callContract(
        MAIN_CONTRACT_LIST.router.address2,
        MAIN_CONTRACT_LIST.router.abi
    ...
    const gas = await contract.methods
      ...
      .estimateGas({ from: to });
    console.log("gas213", gas, gasPrice);

    value = await web3.utils.toHex(value);
    console.log("gas2019", gas, gasPrice, value);
...
const removeLiquidityWithPermit = async (data) => {
  try {
    ...
    console.log("removeliqDATA", data);
    ...
    if (nwChangeId == 338) {
      ...
      console.log("if else338", nwChangeId);
    } else if (nwChangeId == 97) {
      contract = await ContractServices.callContract(
        MAIN_CONTRACT_LIST.router.address2,
        MAIN_CONTRACT_LIST.router.abi
      );
      console.log("if else97", nwChangeId);
    } else if (nwChangeId == 43113) {
      contract = await ContractServices.callContract(
        MAIN_CONTRACT_LIST.router.address3,
        MAIN_CONTRACT_LIST.router.abi
      );
      console.log("if else43113", nwChangeId);
    }
    ...
    if (checkSignature) {
      ...
      const gas = await contract.methods
        ...
        .estimateGas({ from: to });
      value = await web3.utils.toHex(value);
      console.log("gas&&value", gas, value);
